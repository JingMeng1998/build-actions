...
uci set system.@system[0].hostname='OpenWrt-R2S'              # 修改主机名称为OpenWrt-R2S
...
config.buildinfo
feeds.buildinfo
openwrt-nanopi-r2s-generic-kernel.bin
openwrt-nanopi-r2s-generic.manifest
openwrt-nanopi-r2s-generic-squashfs-rootfs.img.gz
sha256sums
version.buildinfo
EOF
